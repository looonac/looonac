...
# $\color{orange}{\text{MY}}$ $\color{blue}{\text{BARRIER}}$ $\color{white}{\text{TRIO}}$ $\color{darkblue}{\text{!!}}$ 
### ╰› [Rot!!](https://github.com/dimofyyy) $\color{white}{\text{the}}$ $\color{orange}{\text{Dimofyy}}$ $\color{blue}{\text{To my loonac!}}$ <br>
### ╰› [Cheron!!](https://github.com/RADIANT-DAY) $\color{white}{\text{the}}$ $\color{darkblue}{\text{Nufuli}}$ $\color{blue}{\text{To my loonac!}}$
